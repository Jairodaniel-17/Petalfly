...
export function NewRequestModal() {
  ...
  const defaults = useAppStore((s) => s.newRequestDefaults);
   ...
   useEffect(() => {
     ...
     setProtocol("http");
     setMethod(protocol === "graphql" ? "POST" : "GET");
     setUrl(protocol === "graphql" ? "http://localhost:4000/graphql" : "http://localhost:3000");
   }, [show, defaults?.collection, protocol]);
    ...
    <div className="modal">
      <div className="modal__content">
        ...
        <div className="modal__body">
          ...
          <option value="grpc" disabled>gRPC (Próximamente)</option>
